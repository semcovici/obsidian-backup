...
* segurança
* manutetenibilidade
* confiadencialidade: refere-se à propriedade de que a infomração é divulgada apenas para partes autorizadas
* integridade: alterações nos ativos de um sitema só podem ser feitas de maneira autorizada, garantindo precisão e completude

Tentamos nos proteger contra ameaçãs à segurança:
